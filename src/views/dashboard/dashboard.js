...
const tiles = [
  ...
  { id: 'release-notes', name: 'Release Notes', description: 'tay up-to-date with the latest enhancements, fixes, and features by accessing our comprehensive release notes\.', Icon: UpdateIcon, link: '/service/release-notes' },
