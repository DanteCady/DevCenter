...
const tiles = [
  ...
  // { id: 'submit-request', name: 'Submit Request', description: 'Find comprehensive articles, how-to guides, and best practices that will help you overcome development challenges and make the most out of the platform.', Icon: HelpOutlineIcon, link: '' },
  // { id: 'release-notes', name: 'Release Notes', description: 'Find comprehensive articles, how-to guides, and best practices that will help you overcome development challenges and make the most out of the platform.', Icon: UpdateIcon, link: '/service/release-notes' },
